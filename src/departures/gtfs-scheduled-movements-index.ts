...
import type { GtfsScheduledTripServicingMovement } from "../data/trip/scheduled/gtfs-scheduled-trip-movements.js";
...
export class GtfsScheduledMovementsIndex {
  static readonly empty = GtfsScheduledMovementsIndex.build(
